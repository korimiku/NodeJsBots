...
const bot = mineflayer.createBot({
  ...
  username: 'KoriLol12', // username to join as if auth is `offline`, else a unique identifier for this account. Switch if you want to change accounts
...
bot.on('chat', (username, message) => {
  ...
  if (message.toLowerCase() === "игроки макс" ) {
